...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stock.date_last_price_updated'
        db.add_column(u'markets_stock', 'date_last_price_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stock.date_last_price_updated'
        db.delete_column(u'markets_stock', 'date_last_price_updated')
