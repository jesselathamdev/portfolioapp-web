...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cash.user'
        db.add_column(u'cash_cash', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['profiles.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cash.user'
        db.delete_column(u'cash_cash', 'user_id')
