...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cash.date_transacted'
        db.add_column(u'cash_cash', 'date_transacted',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cash.date_transacted'
        db.delete_column(u'cash_cash', 'date_transacted')
