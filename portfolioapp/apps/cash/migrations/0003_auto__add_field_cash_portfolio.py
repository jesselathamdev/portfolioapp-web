...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cash.portfolio'
        db.add_column(u'cash_cash', 'portfolio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['portfolios.Portfolio']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cash.portfolio'
        db.delete_column(u'cash_cash', 'portfolio_id')
