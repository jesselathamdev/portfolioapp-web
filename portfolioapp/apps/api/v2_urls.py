...
from .v2_api import get_portfolios, get_portfolio_holdings, get_holdings, get_activity, get_markets, token_create

urlpatterns = patterns('',
    url(r'^portfolios/(?P<portfolio_id>\d+)', get_portfolio_holdings),
