...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Holding.name'
        db.delete_column(u'portfolios_holding', 'name')

        # Deleting field 'Holding.symbol'
        db.delete_column(u'portfolios_holding', 'symbol')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Holding.name'
        raise RuntimeError("Cannot reverse this migration. 'Holding.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Holding.symbol'
        raise RuntimeError("Cannot reverse this migration. 'Holding.symbol' and its values cannot be restored.")
