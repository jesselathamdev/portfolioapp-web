...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Holding.new_market'
        db.delete_column(u'portfolios_holding', 'new_market_id')

        # Adding field 'Holding.market'
        db.add_column(u'portfolios_holding', 'market',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['markets.Market']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Holding.new_market'
        db.add_column(u'portfolios_holding', 'new_market',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['markets.Market']),
                      keep_default=False)

        # Deleting field 'Holding.market'
        db.delete_column(u'portfolios_holding', 'market_id')
