...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.price'
        db.delete_column(u'portfolios_transaction', 'price')
    ...
    def backwards(self, orm):
        # Adding field 'Transaction.price'
        db.add_column(u'portfolios_transaction', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=7, decimal_places=2),
                      keep_default=False)
