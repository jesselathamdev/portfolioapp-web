...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        query = open(os.path.join(basepath, 'sql', '0004_add_portfolio_holdings_view.sql')).read()

        db.execute(query)

    def backwards(self, orm):
        db.execute('DROP VIEW IF EXISTS portfolio_holdings;')
    ...
    models = {
        ...
        u'markets.stock': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_price_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 1, 0, 0)'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'portfolios.portfoliodetail': {
            'Meta': {'object_name': 'PortfolioDetail', 'db_table': "'portfolio_details'", 'managed': 'False'},
            'book_value': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '13', 'decimal_places': '5'}),
            'holding_count': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'market_value': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '13', 'decimal_places': '5'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'net_gain_dollar': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '13', 'decimal_places': '5'}),
            'net_gain_percent': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '13', 'decimal_places': '5'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.User']"})
        },
