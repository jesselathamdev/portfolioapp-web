...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.quantity'
        db.alter_column(u'portfolios_transaction', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))

    def backwards(self, orm):

        # Changing field 'Transaction.quantity'
        db.alter_column(u'portfolios_transaction', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=5))
    ...
    models = {
        ...
        u'portfolios.transaction': {
            ...
            'category_id': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '5'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
