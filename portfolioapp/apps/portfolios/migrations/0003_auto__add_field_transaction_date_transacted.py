...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.date_transacted'
        db.add_column(u'portfolios_transaction', 'date_transacted',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.date_transacted'
        db.delete_column(u'portfolios_transaction', 'date_transacted')
