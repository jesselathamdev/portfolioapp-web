...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'portfolios_transaction', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.commission'
        db.add_column(u'portfolios_transaction', 'commission',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'portfolios_transaction', 'comment')

        # Deleting field 'Transaction.commission'
        db.delete_column(u'portfolios_transaction', 'commission')
