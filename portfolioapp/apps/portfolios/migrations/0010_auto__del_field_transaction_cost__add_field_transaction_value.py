...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'portfolios_transaction', 'cost')

        # Adding field 'Transaction.value'
        db.add_column(u'portfolios_transaction', 'value',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'portfolios_transaction', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=7, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Transaction.value'
        db.delete_column(u'portfolios_transaction', 'value')
