...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.comment'
        db.alter_column(u'portfolios_transaction', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.comment'
        db.alter_column(u'portfolios_transaction', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
